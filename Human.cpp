...
//------------------------------------------------------------------------------------------------------------
void Human::step(Environment* e,vector<Human*>& preys,vector<Stock*>& stocks,const unsigned Timestep) {
...
//------------------------------------------------------------------------------------------------------------
void Human::eat(Environment* e,vector<Human*>& preys,vector<Stock*>& stocks){
