...
//------------------------------------------------------------------------------------------------------------
void Human::setup(unsigned functionalGroup,unsigned numCohortsThisCell,Environment* e,randomizer& r){
    ResetMassFluxes( );
...
//------------------------------------------------------------------------------------------------------------
void Human::setupOffspring( Cohort* actingCohort, double juvenileBodyMass, double adultBodyMass, double initialBodyMass, double initialAbundance, unsigned birthTimeStep ) {
     ResetMassFluxes( );
     _newH=NULL;
...
//------------------------------------------------------------------------------------------------------------
void Human::step(Environment* e,vector<Cohort*>& preys,vector<Stock*>& stocks,const unsigned T) {
...
//------------------------------------------------------------------------------------------------------------
 vector<int> Human::TryToDisperse(double dispersalSpeed, Environment* e,MadModel* m){
 ...
 //------------------------------------------------------------------------------------------------------------
 vector<int> Human::TryToDisperse(double uSpeed, double vSpeed,Environment* e, MadModel* m){
...
//------------------------------------------------------------------------------------------------------------
void Human::eat(Environment* e,vector<Cohort*>& preys,vector<Stock*>& stocks){
